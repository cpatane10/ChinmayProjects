...
sum(TestData5$loss)/nrow(TestData)
#Trying Lasso
C2=TrainData5

C2$loss_binary=NULL
C2$PDS=NULL
cvfit1 = cv.glmnet(loss~. -X ,data=C2, alpha = 1, nlambda =100, type.measure="mae")
plot(cvfit1)
cvfit1$lambda.min
...
TestData6=TestData2
TestData7=filter(TestData6, PDS>0.25)#Keep changing this value to get best MAE. For 0.25 best results are obtained. MAE=3.02 for this threshold.
#TestData7$PDS
#TestData7$loss
...
TestMain5=subset(Z3,DefaulterProb>0.25)
TestMain6=TestMain5
